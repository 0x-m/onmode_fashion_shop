    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_accomplished', models.DateTimeField(default=django.utils.timezone.now, verbose_name='Accomplished date')),
                ('state', models.CharField(choices=[('pending', 'pending'), ('accept', 'accept'), ('rejected', 'rejected'), ('sent', 'sent'), ('received', 'recieved'), ('cancelled', 'cancelled'), ('returned', 'returned'), ('sent_not_verified', 'not verified')], default='pending', max_length=20, verbose_name='State')),
                ('verify_sent', models.BooleanField(default=False, verbose_name='Verify sent')),
                ('tracking_code_status', models.CharField(default='در انتظار تاییدمث', max_length=500, verbose_name='tracking Status')),
            ],
            options={
                'verbose_name': 'Order',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Address', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='orders.orderaddress', verbose_name='Address')),
                ('coupon', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='coupons.coupon', verbose_name='Coupon')),
            ],
            options={
