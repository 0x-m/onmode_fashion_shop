    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('balance', models.DecimalField(decimal_places=0, default=0, max_digits=15, verbose_name='Balance')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('data_accomplished', models.DateTimeField(default=django.utils.timezone.now, verbose_name='Accomplished date')),
                ('amount', models.DecimalField(decimal_places=0, default=django.utils.timezone.now, max_digits=15, verbose_name='Amount')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('state', models.CharField(choices=[('pending', 'prepared'), ('committed', 'committed'), ('rollbacked', 'rollbacked'), ('rejected', 'rejected')], default='pending', max_length=20, verbose_name='State')),
